...
export ASSERT_LINT_PATHS="$REPO_ROOT/agent/tests $REPO_ROOT/agent/src/s3/tests $REPO_ROOT/agent/src/gcs/tests $REPO_ROOT/agent/src/sync/syncer/tests $REPO_ROOT/agent/src/data_uploads/upload/transfer.rs $REPO_ROOT/agent/src/data_uploads/upload/executor.rs"
